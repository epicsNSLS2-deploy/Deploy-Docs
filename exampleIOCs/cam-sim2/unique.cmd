...
epicsEnvSet("IOC", "iocADSimDetector")
...
epicsEnvSet("CAM-CONNECT", "NA")
#epicsEnvSet("CAM-CONNECT",                   "10.10.1.91")
#epicsEnvSet("CAM-CONNECT",	"/opt/xsp/config")


# PV and IOC Name configs
epicsEnvSet("PREFIX", "XF:10IDC-BI{SimDetector-Cam:2}")
epicsEnvSet("CTPREFIX", "XF:10IDC-BI{SimDetector-Cam:2}")
epicsEnvSet("HOSTNAME", "localhost")
epicsEnvSet("IOCNAME", "cam-sim2")
